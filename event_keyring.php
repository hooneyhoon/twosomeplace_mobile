...
<html lang="ko">
  <head>
    ...
    <title>투썸플레이스 키링이벤트</title>
    <link rel="shortcut icon" href="img/favicon.ico">
    <link
      rel="stylesheet"
      href="css/event_keyring.css"
      type="text/css"
    />
  ...
  <body>
   ...
   <div class="header_wrap">
    ...
    <div class="event_title_bg"></div>
    <section>
    <p class="title_text">
          <span class="redTxt">투썸플레이스</span>의 다양한 이벤트를 누려보세요!
    </p>
    </section>
    <section class="event">
       ...
       <h2>투썸플레이스 이벤트</h2>
        ...
        <section class="title">
            <p class="title_1">투썸플레이스 스트로베리 키링 프로모션<span class="event_end">이벤트종료</span></p>
            <p>이벤트 기간 : 3/5 ~ 소진시까지</p>
        </section><!--//title-->
        <section>
            <p class="event_txt">
               strawberry행사제품 구매시, 스트로베리키링 할인해서 2천원<br>행사기간 2020.03.05(목)에서 제품 소진시까지<br> 스트로베리행사제품<br>음료: 스트로베리 아보카도 라떼, 스트로베리라떼, 스트로베리요거프라페, 스트로베리 피치프라페<br>디저트:떠먹는 스트로베리 초콜릿 생크림, 딸기 생크림 피스, 떠먹는 딸기 레어 치즈, 비 마이 스트로베리 피스, 딸기 요거 피스, 생딸기 가득 타르트 피스, 베리 블라썸무스<br>
               행사가로 구매하는 스트로베리 키링은 이벤트, 제휴할인 중복적용, 모바일제품교환권 사용이 불가합니다.<br>
               행사가 구매시, CJONE포인트는 최종결제금액의 0.5%적립됩니다.<br>매장에따라 strawberry행사 제품이 상이할수 있습니다.<br>행사진행매장은 상이할 수 있습니다.<br>구매하신 행사 제품의 교환/환불 시에는 구매 영수증과 함께 행사가 구매 제품을 지참하시기 바랍니다.
            </p>
            <div class="keyring_event"></div>
        </section>
       </section><!--//event-->
       <a href="twosomeplace_event.php" class="btn">이벤트 목록으로</a>
    </main>
