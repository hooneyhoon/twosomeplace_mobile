...
<html lang="ko">
  <head>
    ...
    <title>투썸플레이스 기업및단체구매</title>
    <link rel="shortcut icon" href="img/favicon.ico">
    <link
      rel="stylesheet" href="css/twosomeplace_Corporate_and_group_purchasing.css"
      type="text/css"
    />
   ...
   <div class="header_wrap">
    ...
    <main>
      ...
      <section class="title_text_bg">
        <h2>기업 및 단체구매</h2>
        <p>
          투썸플레이스에서는 품격있는 다양한 상품을 통해 기업 및 단체 고객에게
          최적화된 서비스를 제공 드리고 있습니다.<br />투썸플레이스에서 판매하고
          있는 다양한 상품의 대량구매 및 상담을 도와드립니다.
        </p>
      </section>
      <!--//title_text_bg-->

      <div class="puchase_wrap">
        <section class="puchase_product">
          <h2>대량 구매 품목</h2>

          <dl class="product1">
            <dt>투썸 모바일 쿠폰</dt>
            <dd>
              투썸플레이스의<br />다양한 상품을 모바일쿠폰으로<br />간편하게
              선물하세요.
            </dd>
          </dl>
          <dl class="product2">
            <dt>투썸플레이스 상품</dt>
            <dd>
              투썸플레이스만의<br />고급스러운 텀블러, 스틱커피 등<br />다양한
              상품으로<br />귀사의 가치를 높여드립니다.
            </dd>
          </dl>
          <dl class="product3">
            <dt>투썸 e-giftcard</dt>
            <dd>
              다양한 디자인의<br />투썸플레이스 e-giftcard를<br />MMS 전송
              방식으로<br />간편하고 정확하게<br />선물하실 수 있습니다.<br />*
              스페셜 카드 제작 가능
            </dd>
          </dl>
          <dl class="product4">
            <dt>투썸 기프트카드</dt>
            <dd>
              투썸플레이스만의<br />다양한 멤버스혜택을 드리는<br />투썸기프트카드를
              통해<br />더욱 특별한 선물이 가능합니다.<br />* 스페셜 카드 제작
              가능
            </dd>
          </dl>
        </section>
        ...
        <section class="puchase_info">
          <h2>기업 및 단체 구매 상담 안내</h2>
          <ul>
            <li class="puchase_info1">
              구매 상담 운영시간 : 월~금 09:00 ~ 17:00 (12:30~13:30 제외,
              토·일요일, 공휴일 휴무)
            </li>
            <li class="puchase_info2">
              상품 구매 및 상담 문의 : 이메일 (twosomebiz@cj.net), 전화
              (02-2058-6568)
            </li>
            <li class="puchase_info3">
              이메일 또는 유선문의 주시면 대량 구매에 따른 혜택 등 자세한 사항
              안내 드립니다.
            </li>
            <li class="puchase_info4">
              답변 및 안내는 상담 운영시간 내에 이메일 또는 전화번호로 안내
              드립니다.
            </li>
            <li class="puchase_info5">
              기재 오류시 답변이 불가할 수 있으니 기재 시 꼭 메일주소 및
              전화번호를 확인해 주시기 바랍니다.
            </li>
          </ul>
        </section>
