...
<head>
    ...
    <title>투썸플레이스 이메일 무단수집거부</title>
    <link rel="shortcut icon" href="img/favicon.ico">
    <link rel="stylesheet" href="css/twosomeplace_e-mail_collection.css" type="text/css">
   ...
   <div class="header_wrap">
    ...
    <main>
        ...
        <section class="term_of_use">
            <h2>투썸플레이스 이메일 무단수집거부</h2>
            <div>
              <h3>본 웹사이트에 게시된 이메일 주소가 전자우편수집 프로그램이나 그 밖의 기술적 장치를 이용하여 무단으로 수집되는 것을 거부하며, 이를 위반시 정보통신망법에 의해 형사 처벌됨을 유념하시기 바랍니다.</h3>
              <p>[게시일 2004년 9월 3일]</p>
