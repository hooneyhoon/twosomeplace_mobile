...
<head>
    ...
    <title>투썸플레이스 케이터링서비스</title>
    <link rel="shortcut icon" href="img/favicon.ico">
    <link rel="stylesheet" href="css/twosomeplace_service_catering.css" type="text/css">
...
<body>
   ...
   <div class="header_wrap">
    ...
    <main>
     <div class="catering_bg"></div>
     <div class="background">
     <div class="catering_wrap">
      <p class="catering_text_1">CATERING SERVICE</p>
      <h2>케이터링 서비스 이용 안내</h2>
      <p class="catering_text_2">케이터링 서비스는 모임, 회식, 결혼, 피로연, 송년회, 신년회 등을 위한 단체 주문 서비스 입니다.</p>
     </div><!--//catering_wrap-->
     <section class="catering_img"></section>
     <section class="catering_text_3">
      <ul>
          <li>· 사전에 가까운 매장으로 전화 문의를 통해 주문해 주세요.</li>
          <li>· 00잔 이상 주문시 케이터링이 가능합니다.<span class="catering_txtbox_1">(매장별 상이)</span></li>
          <li>· 모든 디저트들도 단체 주문시 케이터링가능합니다.</li>
          <li>· 단체 주문시 할인 적용에 대해서 매장 담당직원에게 문의해 주세요.</li>
      </ul>
      <p class="catering_txtbox_2">케이터링 및 단체 주문시 사전에 미리 전화 주시면 신속히 준비해 드리겠습니다.</p>
     </section><!--//catering_text-->
      <a href="#" class="catering_store">가까운 매장 찾기</a>
    </div><!--//background-->
    </main>
