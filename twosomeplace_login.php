...
<html lang="ko">
  <head>
    ...
    <title>투썸플레이스 로그인</title>
    <link rel="shortcut icon" href="img/favicon.ico">
    <link
      rel="stylesheet"
      href="css/twosomeplace_login.css"
      type="text/css"
    />
            ...
            <section class="login_box">
              <form name="login_form" action="login_ok.php" method="post">
                <fieldset class="box">
                  <legend>로그인</legend>
                  <p class="textbox1">
                    <label for="uid" class="uid">아이디를 입력하세요.</label>
                    <input
                      type="text"
                      name="uid"
                      id="uid"
                  ...
                  <p class="textbox2">
                    <label for="pwd" class="pwd">비밀번호를 입력하세요.</label>
                    <input
                      type="password"
                      name="pwd"
                      id="pwd"
              ...
              <div class="box3">
                <p class="box3_1"><a href="members_id_find.php">아이디 찾기</a></p>
                <p class="box3_2"><a href="members_pwd_find.php">비밀번호 찾기</a></p>
                <p class="box3_3"><a href="twosomeplace_join.php">CJONE 통합회원가입하기</a></p>
              </div>
            </section>
          </div>
          <!--//main_wrap2-->
