...
<html lang="ko">
  <head>
    ...
    <title>투썸플레이스 공지관리</title>
    <link rel="shortcut icon" href="img/favicon.ico">
    <link
      rel="stylesheet"
      href="css/admin_notice.css"
      type="text/css"
    />
    ...
    function edit_form_check(){
        ...
        document.edit_notice_form.submit();
    }
    </script>
  </head>
  <body>
   ...
   <div class="header_wrap">
    ...
    <section class="admin_notice">
       <h2>투썸플레이스 공지관리</h2>
       <p>
           <a href="admin_notice.php" class="comeback">공지관리로 돌아가기</a>
       </p>
       <hr>
       ...
       <section class="notice_registration">
           <h3>투썸플레이스 공지수정</h3>
               ...
               <form name="edit_notice_form" action="edit_notice_ok.php" method="post">
                   <fieldset class="form">
                       <legend>투썸플레이스 공지수정</legend>
                       <p class="category">
                           ...
                           <select name="category" id="category" class="sel_category">
                               <option value="">-- 공지 카테고리 선택 --</option>
