...
<html lang="ko">
  <head>
    ...
    <title>투썸플레이스 관리자모드</title>
    <link rel="shortcut icon" href="img/favicon.ico">
    <link
      rel="stylesheet"
      href="css/administrator_mode.css"
      type="text/css"
    />
  ...
  <body>
   ...
   <div class="header_wrap">
    ...
    <div class="administrator_title_bg"></div>
    <section class="admin_menu">
        <h2>관리자 메뉴</h2>
        <ul>
            <li class="admin_menu1"><a href="admin_member.php" class="click">회원 관리</a></li>
            <li class="admin_menu2"><a href="admin_cakeclass.php" class="click">케이크클래스<br>예약 관리</a></li>
            <li class="admin_menu3"><a href="admin_seminar.php" class="click">창업설명회<br>예약 관리</a></li>
            <li class="admin_menu4"><a href="admin_customer.php" class="click">고객의소리<br>관리</a></li>
            <li class="admin_menu5"><a href="admin_information.php" class="click">정보공개서<br>신청 관리</a></li>
            <li class="admin_menu6"><a href="admin_online.php" class="click">온라인창업<br>상담신청 관리</a></li>
            <li class="admin_menu7"><a href="admin_notice.php" class="click">공지 관리</a></li>
            <li class="admin_menu8"><a href="admin_recuit.php" class="click">채용 관리</a></li>
            <li class="admin_menu9"><a href="admin_store_event.php" class="click">매장별<br>이벤트 관리</a></li>
            <li class="admin_menu10"><a href="admin_store_open.php" class="click">신규오픈<br>매장관리</a></li>
        </ul>
    </section><!--//admin_menu-->
    </main>
