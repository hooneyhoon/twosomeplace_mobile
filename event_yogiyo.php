...
<html lang="ko">
  <head>
    ...
    <title>투썸플레이스 요기요이벤트</title>
    <link rel="shortcut icon" href="img/favicon.ico">
    <link
      rel="stylesheet"
      href="css/event_yogiyo.css"
      type="text/css"
    />
   ...
   <div class="header_wrap">
    ...
    <section class="event">
       ...
       <h2>투썸플레이스 이벤트</h2>
        ...
        <section class="title">
            <p class="title_1">투썸 요기요 5월 슈퍼레드위크 프로모션</p>
            <p>이벤트 기간 : 5/1 ~ 5/31</p>
        </section><!--//title-->
        <section>
            <p class="event_txt">
                요기요로 주문하면 최대 3,000원 할인<br>
                투썸의 달콤한 디저트와 시원한 커피가 생각나는 5월에는 요기요로 주문해서 즐겨보세요.<br>
                혜택1. 5월 한달간(매일) 2천원 할인<br>
                혜택2. 5월18일(월)~5월24일(일), 7일간 3천원 할인<br>
                혜택1과 혜택2는 중복적용이 불가합니다.<br>
                자세한 내용은 요기요 앱에서 확인하세요.
            </p>
            <div class="yogiyo_event"></div>
        </section>
