...
$sql = "select * from customer_opinion;";
...
<html lang="ko">
  <head>
    ...
    <title>투썸플레이스 고객의 소리 관리</title>
    <link rel="shortcut icon" href="img/favicon.ico">
    <link
      rel="stylesheet"
      href="css/admin_customer.css"
      type="text/css"
    />
    ...
    <section class="admin_members">
       ...
       <table>
           <tr class="title">
               ...
               <td width="200">매장명</td>
               <td width="300">고객의소리종류</td>
               <td width="600">제목</td>
               <td width="1000">내용</td>
               <td width="80">약관동의</td>
               <td width="80">약관동의(선택)</td>
               <td width="200">신청일</td>
               <td width="100">삭제</td>
           </tr>
           ...
           <?php
            ...
            <tr>
                ...
                <td width="200"><?php echo $array["store"]; ?></td>
                <td width="300"><?php echo $array["choice"]; ?></td>
                <td width="600"><?php echo $array["title"]; ?></td>
                <td width="1000"><?php echo $array["main_text"]; ?></td>
                <td width="80"><?php echo $array["apply"]; ?></td>
                <td width="80"><?php echo $array["apply_choice"]; ?></td>
                <td width="200"><?php echo $array["reg_date"]; ?></td>
                <td width="100">
                <a href="delete_customer.php?idx=<?php echo $array["idx"]; ?>" class="redTxt">삭제</a>
            </td>    
            </tr>
            <?php
            }
