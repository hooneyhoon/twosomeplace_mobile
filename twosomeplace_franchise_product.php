...
<head>
    ...
    <title>투썸플레이스 가맹점전용 금융상품</title>
    <link rel="shortcut icon" href="img/favicon.ico">
    <link rel="stylesheet" href="css/twosomeplace_franchise_product.css" type="text/css">
...
<body>
   ...
   <div class="header_wrap">
    ...
    <main>
      <h2>가맹점 전용 금융상품</h2>
      <p>CJ푸드빌 가맹점을 위한 특별한 금융상품에 대해 알려드립니다!</p>
      ...
      <dl>
          ...
          <dd>창업자금: 최대8천</dd>
          <dt>우리은행</dt>
          <dd>창업자금:최대1억원<br>(창업소요자금2/3범위내)</dd>
      </dl>
      <h3>대출금리</h3>
      <dl>
          <dt>농협은행</dt>
          <dd>신용등급 4등급기준 4.7%</dd>
          <dt>하나은행</dt>
          <dd>신용등급 3등급기준 3.90%</dd>
          <dt>우리은행</dt>
          <dd>신용등급 1,2등급기준 3.75%</dd>
          <dd>신용등급 3등급기준 3.99%</dd>
          <dd>신용등급 4등급기준 4.29%</dd>
      </dl>
      <h3>대출기간</h3>
      <dl>
          <dt>농협은행</dt>
          <dd>창업자금<br>-할수상환:5년이내(1년거치)운영자금<br>-할부상환:3년이내,일시상환(1년이내)</dd>
          <dt>하나은행</dt>
          <dd>만기일시상환/부분원리금<br>분할상환(선택가능)<br>1~3년</dd>
          <dt>우리은행</dt>
          <dd>만기일시상환<br>(마이너스대출포함):1년이내<br>분할상환:5년이내</dd>
      </dl>
      <h3>대출문의</h3>
      <dl>
          <dt>농협은행</dt>
          <dd>농협은행 1588-2100</dd>
          <dt>하나은행</dt>
          <dd>김낙훈팀장(영업지원본부)<br>연락처:02-2002-1140</dd>
          <dt>우리은행</dt>
          <dd>CJ금융센터 부지점장 차정광<br>연락처:02-2266-3200(내선510)</dd>
      </dl>
      <p>*대출한도 및 대출금리는 채무자의 신용등급에 따라 차등 적용됩니다.</p>
      <p>*대출금액에 따른 인지대등 부대비용이 발생할 수 있습니다.</p>
      <p>*대출금리 수준은 기준 금리 변동에 따라 변동할 수 있습니다.</p>
    </main>
