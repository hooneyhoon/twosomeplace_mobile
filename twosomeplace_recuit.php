...
<html lang="ko">
  <head>
    ...
    <title>투썸플레이스 채용 공고</title>
    <link rel="shortcut icon" href="img/favicon.ico">
    <link
      rel="stylesheet"
      href="css/twosomeplace_recuit.css"
      type="text/css"
    />
  ...
  <body>
   ...
   <div class="header_wrap">
    ...
    <div class="recuit_title_bg"></div>
    <section>
    <p class="title_text">
          <span class="redTxt">투썸플레이스</span>와 함께 하실 분들을 모집합니다!
    </p>
    </section>
       ...
       <h2>투썸플레이스 채용 공고</h2>
        ...
        <section class="title">
           <table>
               <tr>
                   ...
                   <td width="180" align="center">카테고리</td>
        ...
        <section class="content_title">
               ...
               <section class="contents">
                   ...
                   <p class="content_3"><a href="view_recuit.php?idx=<?php echo $array["idx"]; ?>"><?php echo $array["title"]; ?></a></p>
