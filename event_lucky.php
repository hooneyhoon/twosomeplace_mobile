...
<html lang="ko">
  <head>
    ...
    <title>투썸플레이스 럭키드로우이벤트</title>
    <link rel="shortcut icon" href="img/favicon.ico">
    <link
      rel="stylesheet"
      href="css/event_lucky.css"
      type="text/css"
    />
   ...
   <div class="header_wrap">
    ...
    <section class="event">
       ...
       <h2>투썸플레이스 이벤트</h2>
        ...
        <section class="title">
            <p class="title_1">투썸 2020 럭키 드로우 이벤트<span class="event_end">이벤트종료</span></p>
            <p>이벤트 기간 : 1/22 ~ 2/29</p>
        </section><!--//title-->
        <section>
            <p class="event_txt">
               2020럭키드로우이벤트<br>참여비: 3천원<br>
               100%당첨이벤트<br>당첨물품:아메리카노, 스틱커피, 핸드드립커피, 머그, 텀블러, 데일리키트등<br>
               유의사항<br>본 행사는 한전 매장에서 진행됩니다.<br>
               본 행사의 상품은 일부 재고 상품으로 구성 되어있습니다.<br>임직원 및 기타 제휴 카드할인, mms쿠폰 사용 불가합니다.(단 cjone 정상적립 가능)<br>소비자의 책임 있는 사유로 상품 등이 멸실 또는 훼손된 경우 교환 및 반품 불가합니다.<br>본 행사는 환불이 불가한 이벤트입니다.<br>교환하신 제품은 불량 발견시 환불은 불가하며, 동일 제품 또는 동일 가격대 제품으로 교환하여 드립니다.<br>본행사는 매장별로 이벤트 시작일이 상이할 수 있습니다.
            </p>
            <div class="lucky_event"></div>
        </section>
      </section><!--//event-->
