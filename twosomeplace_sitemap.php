...
<head>
    ...
    <title>투썸플레이스 사이트맵</title>
    <link rel="shortcut icon" href="img/favicon.ico">
    <link rel="stylesheet" href="css/twosomeplace_sitemap.css" type="text/css">
...
<body>
   ...
   <div class="header_wrap">
    ...
    <main>
        ...
        <h3>메뉴</h3>
        <ul>      
            <li><a href="twosomeplace_menu_coffee.php">COFFEE</a><li>
            <li><a href="twosomeplace_menu_beverage.php">BEVERAGE</a><li>
            <li><a href="twosomeplace_menu_food.php">FOOD</a><li>
            <li><a href="twosomeplace_menu_md.php">MD상품</a><li>
            <li><a href="twosomeplace_menu_wholecake.php">WHOLE CAKE</a><li>
        </ul>
        </section><!--//menu-->
        ...
        <h3>매장</h3>
        <ul>
            <li><a href="twosomeplace_store_search.php">매장찾기</a></li>
            <li><a href="twosomeplace_store_grandopen.php">신규오픈매장</a></li>
            <li><a href="twosomeplace_store_event.php">매장별이벤트</a></li>
        </ul>
        </section><!--//store-->
        ...
        <h3>프랜차이즈</h3>
        <ul>
            <li><a href="twosomeplace_franchise_opensystem.php">창업정보 및 절차</a></li>
            <li><a href="twosomeplace_franchise_online_application.php">온라인 창업상담</a></li>
            <li><a href="twosomeplace_franchise_bankingproduct.php">가맹점전용 금융상품</a></li>
            <li><a href="twosomeplace_franchise_Information_Disclosure_Application.php">가맹점 정보공개서</a></li>
            <li><a href="twosomeplace_franchise_FAQ.php">FAQ</a></li>
            <li><a href="twosomeplace_franchise_seminar.php">창업설명회</a></li>
        </ul>
        </section><!--//franchise-->
        ...
        <h3>커뮤니티</h3>
        <ul>
            <li><a href="twosomeplace_news.php">뉴스&amp;공지</a></li>
            <li><a href="twosomeplace_event.php">이벤트</a></li>
            <li><a href="twosomeplace_service_center.php">고객센터</a></li>
        </ul>
        </section><!--//comm-->
        ...
        <h3>서비스</h3>
        <ul>
            <li><a href="twosomeplace_service_mobileapp.php">모바일투썸APP</a></li>
            <li><a href="twosomeplace_service_cakeclass.php">케익클래스</a></li>
            <li><a href="twosomeplace_Corporate_and_group_purchasing.php">기업 및 단체구매</a></li>
            <li><a href="twosomeplace_service_catering.php">케이터링서비스</a></li>
            <li><a href="twosomeplace_service_membership.php">멤버십&amp;제휴</a></li>
        </ul>
        </section><!--//service-->
        </div><!--//middle-->
        
        <div class="bottom">
        <section class="twosome">
        <h3>투썸플레이스</h3>
        <ul>
            <li><a href="twosomeplace_brandis.php">BRAND is</a></li>
            <li><a href="wosomeplace_coffeeis.php">COFFEE is</a></li>
            <li><a href="twosomeplace_dessertis.php">DESSERT is</a></li>
            <li><a href="twosomeplace_recuit.php">RECRUIT</a></li>
        </ul>
        </section><!--//twosome-->
        ...
        <h3>MY투썸</h3>
        <ul>    
            <li><a href="twosomeplace_my_mymembership.php">MY멤버십</a></li>
            <li><a href="twosomeplace_my_edit.php">개인정보관리</a></li>
        </ul>
        </section><!--//my-->
        </div><!--//bottom-->
        </div><!--//sitemap_wrap-->
