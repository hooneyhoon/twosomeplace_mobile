...
$sql = "select * from recuit where idx='$idx';";
...
<html lang="ko">
  <head>
    ...
    function edit_form_check(){
        ...
        document.edit_recuit_form.submit();
    }
    </script>
  </head>
  <body>
   ...
   <div class="header_wrap">
    ...
    <div class="admin_notice_title_bg"></div>
    <section class="admin_notice">
       <h2>투썸플레이스 채용관리</h2>
       <p>
           <a href="admin_recuit.php" class="comeback">채용관리로 돌아가기</a>
       </p>
       <hr>
       
       <section class="notice_registration">
           <h3>투썸플레이스 채용공고 수정</h3>
               
               <form name="edit_recuit_form" action="edit_recuit_ok.php" method="post">
                   <fieldset class="form">
                       <legend>투썸플레이스 채용공고 수정</legend>
                       <p class="category">
                       ...
                       <p class="title_notice">
                           ...
                           <input type="text" name="title" id="title" class="title_input" value="<?php echo $array["title"]; ?>">
                       ...
                       <p class="content">
                           ...
                           <textarea name="content" id="content" class="content_input"><?php echo $array["content"]; ?></textarea>
                       </p>
                   </fieldset>
                   <button type="button" onclick="edit_form_check()" class="btn">공지수정</button>
               </form>
       </section><!--//notice_registration-->
    </section><!--//admin_notice-->
    </main>
