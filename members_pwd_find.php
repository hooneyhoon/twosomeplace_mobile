...
<html lang="ko">
  <head>
    ...
    <link
      rel="stylesheet"
      href="css/twosomeplace_login_pwd_find.css?after"
      type="text/css"
    />
  ...
  <body>
   ...
   <div class="header_wrap">
    ...
    <main>
      ...
      <div class="main_bg">
        <section class="members_find">
          <h2>CJ ONE 회원정보 찾기</h2>
          <form
            name="find_pwd_form"
            action="members_pwd_edit.php"
            method="post"
            class="find_pwd_form"
          >
              <fieldset>
                <legend>비밀번호 찾기</legend>
                <p class="find_pwd_title">비밀번호를<br />잊어버리셨나요?</p>
                <div class="find_pwd_input">
                  ...
                  <p>
                    <input
                      ...
                      id="mobile"
                      class="mobile"
                      placeholder="휴대전화를 입력해주세요.(숫자만입력)"
                    />
                  </p>
                  <p>
                    <input
                ...
                <p>
                  <button
                    type="button"
                    onclick="pwd_find_check()"
                    class="find_pwd_button"
                  >
                    비밀번호 찾기
                  </button>
                </p>
