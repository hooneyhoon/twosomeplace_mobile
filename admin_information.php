...
$sql = "select * from information_application;";
...
<html lang="ko">
  <head>
    ...
    <title>투썸플레이스 정보공개서 신청</title>
    <link rel="shortcut icon" href="img/favicon.ico">
    <link
      rel="stylesheet"
      href="css/admin_information.css"
      type="text/css"
    />
    ...
    <section class="admin_members">
       ...
       <table>
           <tr class="title">
               <td width="80">번호</td>
               <td width="100">아이디</td>
               <td width="200">신청자구분</td>
               <td width="200">이름</td>
               <td width="500">점포명(가맹사업자)</td>
               <td width="200">이메일</td>
           ...
           <?php
            ...
            <tr>
                ...
                <td width="200"><?php echo $array["user"]; ?></td>
                <td width="200"><?php echo $array["uname"]; ?></td>
                <td width="500"><?php echo $array["store_name"]; ?></td>
