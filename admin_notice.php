    ...
    <section class="admin_notice">
       ...
       <section class="notice_registration">
           <h3>투썸플레이스 공지등록</h3>
               ...
               <form name="notice_form" action="admin_notice_ok.php" method="post">
                   <fieldset class="form">
                       <legend>투썸플레이스 공지등록</legend>
                       <p class="category">
       ...
       <hr>
       <section class="notice_management">
        <h3>투썸플레이스 공지현황</h3>
        ...
        <section>
           <?php
            ...
            <section class="contents">
                ...
                <p class="content_6">
                    <a href="edit_notice.php?idx=<?php echo $array["idx"]; ?>" class="redTxt">수정</a>
                </p>
                <p class="content_7">
                <a href="delete_notice.php?idx=<?php echo $array["idx"]; ?>" class="redTxt">삭제</a>
                </p> 
            </section><!--//contents-->
                <?php
            $cnt--
