...
<html lang="ko">
  <head>
    ...
    <title>투썸플레이스 매장별 이벤트</title>
    <link rel="shortcut icon" href="img/favicon.ico">
    <link
      rel="stylesheet"
      href="css/twosomeplace_store_event.css"
      type="text/css"
    />
  ...
  <body>
   ...
   <div class="header_wrap">
    ...
    <div class="store_event_title_bg"></div>
    <section>
    <p class="title_text">
          <span class="redTxt">투썸플레이스</span>는 각 매장에서 다양한 이벤트를 진행하고 있습니다.
    </p>
    </section>
    <section class="store_event">

       <h2>투썸플레이스 매장별 이벤트</h2>
       <p>매장별 이벤트는 해당 매장에서만 진행됩니다.</p>
       
        <section class="title">
           <table>
               <tr>
                   <td width="100" align="center" class="number">번호</td>
                   <td width="200" align="center" class="store_name">행사매장</td>
                   <td width="420" align="center" class="event_1">행사내용</td>
                   <td width="200" align="center" class="event_2">행사기간</td>
               </tr>
           </table>
        </section><!--//title-->
