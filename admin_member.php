...
$sql = "select * from twosome_members;";
   ...
   <div class="header_wrap">
    ...
    <section class="admin_members">
       ...
       <p class="total_people">
            투썸플레이스 회원: 총 <span class=""><?php echo $num ?></span>명
       </p>
       <table>
           <tr class="title">
               <td width="80">번호</td>
           ...
           <?php
            ...
            <tr>
                ...
                <td width="200"><?php echo $array["uid"]; ?></td>
                <td width="150"><?php echo $array["mobile"]; ?></td>
                <td width="200"><?php echo $array["email"]; ?></td>
                <td width="100"><?php echo $array["postalcode"]; ?></td>
                <td width="500"><?php echo $array["address_1"]; ?></td>
                <td width="500"><?php echo $array["address_2"]; ?></td>
                <td width="80"><?php echo $array["apply"]; ?></td>
                <td width="200"><?php echo $array["reg_date"]; ?></td>
                <td width="80">
                    <a href="edit.php?idx=<?php echo $array["idx"]; ?>" class="redTxt">수정</a>
                </td>
                <td width="80">
                <a href="delete.php?idx=<?php echo $array["idx"]; ?>" class="redTxt">삭제</a>
            </td>    
            </tr>
            <?php
            }
