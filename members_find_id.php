...
$sql = "select uid from twosome_members where  uname='$uname' and mobile='$mobile' and email='$email';";
...
<html lang="ko">
  <head>
    ...
    <title>투썸플레이스 회원정보찾기</title>
    <link rel="shortcut icon" href="img/favicon.ico">
    <link
      rel="stylesheet"
      href="css/members_find_id.css"
      type="text/css"
    />
  ...
  <body>
    ...
    <div class="main_bg">
    <section class="id_find_result">
    <h2>아이디찾기 결과</h2>
    <p class="result_txt">
        회원님의 아이디는 <span class="rTxt">" <?php echo $array["uid"]; ?> "</span> 입니다.
    </p>
    <a href="twosomeplace_login.php" class="login_txt">로그인</a>
    </section><!--//id_find_result-->
    </div><!--//main_bg-->
      ...
      <div class="footer_bottom">
        <div class="footer_bottom_wrap1">
          <address class="footer1">
            서울특별시 중구
            을지로170,8층(을지로4가,을지로트윈타워)투썸플레이스㈜
          </address>
        ...
        <p class="footer9">
          copyright &copy; 2019 A TWOSOME PLACE CO.LTD.ALL RIGHTS RESERVED
        </p>
      </div>
      <!--//footer_bottom-->
    </footer>
