...
$sql = "select * from seminar_reservation;";
...
<html lang="ko">
  <head>
    ...
    <title>투썸플레이스 창업설명회 예약관리</title>
    <link rel="shortcut icon" href="img/favicon.ico">
    <link
      rel="stylesheet"
      href="css/admin_seminar.css"
      type="text/css"
    />
  ...
  <body>
   ...
   <div class="header_wrap">
    ...
    <section class="admin_members">
       <h2>투썸플레이스 창업설명회 예약관리</h2>
       <p>
           <a href="administrator_mode.php" class="comeback">관리자 메뉴로 가기</a>
       </p>
       <hr>
       <p class="total_people">
            투썸플레이스 창업설명회 예약: 총 <span class=""><?php echo $num ?></span>건
       </p>
       <table>
           <tr class="title">
               <td width="80">번호</td>
               <td width="100">아이디</td>
               <td width="500">예약날짜</td>
               <td width="200">이름</td>
               ...
               <td width="200">창업 희망지역</td>
               <td width="200">점포보유여부</td>
               <td width="200">보유자금</td>
               <td width="80">약관동의</td>
               <td width="200">신청일</td>
               <td width="100">삭제</td>
           </tr>
           ...
           <?php
            ...
            <tr>
                ...
                <td width="500"><?php echo $array["reservation_date"]; ?></td>
                ...
                <td width="200"><?php echo $array["hope_area"]; ?></td>
                <td width="200"><?php echo $array["hold"]; ?></td>
                <td width="200"><?php echo $array["funds"]; ?></td>
                <td width="80"><?php echo $array["apply"]; ?></td>
                <td width="200"><?php echo $array["reg_date"]; ?></td>
                <td width="100">
                <a href="delete_seminar.php?idx=<?php echo $array["idx"]; ?>" class="redTxt">삭제</a>
            </td>    
            </tr>
            <?php
            }
