...
<html lang="ko">
  <head>
    ...
    <title>투썸플레이스 매장 찾기</title>
    <link rel="shortcut icon" href="img/favicon.ico">
    <link
      rel="stylesheet"
      href="css/twosomeplace_store_search.css"
      type="text/css"
    />
  ...
  <body>
   ...
   <div class="header_wrap">
    ...
    <div class="store_search_title_bg"></div>
    <section>
    <p class="title_text">
          가까운 <span class="redTxt">투썸플레이스</span>를 찾아보세요!
    </p>
    </section>
    ...
    <div class="map_wrap">
    <div id="map" style="width:760px;height:450px;position:relative;overflow:hidden;left:346px"></div>
...
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=a1b38293335e1bb995c823c3283c3ab0&libraries=services"></script>
<script>
// 마커를 담을 배열입니다
var markers = [];
