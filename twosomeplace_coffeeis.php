...
<html lang="ko">
  <head>
    ...
    <title>투썸플레이스 커피소개</title>
    <link rel="shortcut icon" href="img/favicon.ico">
    <link
      rel="stylesheet"
      href="css/twosomeplace_coffeeis.css"
      type="text/css"
    />
  ...
  <body>
   ...
   <div class="header_wrap">
    ...
    <div class="coffeeis_title_bg"></div>
    <section class="coffeeis_sub_title">
        <p class="sub_title_1"><span class="redTxt_b">투썸플레이스</span>의 개성있는 풍미의 두가지 블렌드를 소개합니다.</p>
    </section>
    <section class="twosome_intro">
        <h2>투썸플레이스 커피소개</h2>
        <p class="coffee_intro">
            투썸의 큐그레이더는 좋은 산지의 신선한 원두만을 선별해 <span class="bTxt">개성 있는 풍미의 두가지 블렌드</span>를 제공합니다.<br>원두 타입별 <span class="bTxt">최적의 로스팅 포인트, 최상의 에스프레소 추출 기술</span>이 더해져<br>오늘도 <span class="bTxt">가장 맛있는 커피가 완성</span>됩니다.
        </p>
    </section><!--//twosome_intro-->
    <section class="blend_intro">
        <h2>투썸플레이스 블렌딩 소개</h2>
        <div class="blackground_wrap">
        <section class="black_ground_intro">
        <h3 class="bTxt">BLACK GROUND</h3>
        <ul class="black_ground_txt">
            <li>블랙그운드 블랜딩</li>
            <li>Dark Roast</li>
            <li>sensery : full - body , nutty , chocolaty</li>
            <li>#Origin<br>Colombia / Brazil / Ethiopia / Guatemala</li>
            <li>묵직하고 스모키한 첫인상과 달콤 쌉싸름한 여운이 매력적인 다크로스팅 블렌드.</li>
            <li> 따뜻한 햇살과 바림이 머무는 부드러운 흙 위를 맨발로 거닐듯<br>짙은 여유를 즐기고 싶은 순간 가장 잘 어울리는<br>블랙그라운드 브렌드.</li>
        </ul>
        </section><!--//black_ground_intro-->
        </div><!--//blackground_wrap-->
        <div class="aroma_wrap">
        <section class="aroma_note_intro">
            <h3>AROMA NOTE</h3>
            <ul class="aroma_note_txt">
                <li>아로마 노트 블렌딩</li>
                <li>Medium Roast</li>
                <li>sensery : berry - like , juicy , floral</li>
                <li>#Origin<br>Colombia / Brazil / Ethiopia </li>
                <li>플로럴한 화사함과 열대과일의 새콤달콤에 부드러운 바디감이 조화롭게<br>어우러진 스페셜티 커피 블렌딩.</li>
                <li> 좋은 향수가 시간에 흐름에 따라 인상적인 잔향을 남기 듯 첫 모금부터<br>마지막까지 다채로운 맛과 향이 생동감 있게 펼쳐지는<br>아로마 블렌드.</li>
            </ul>
        </section><!--//aroma_note_intro-->
        </div><!--//aroma_wrap-->
    </section><!--//blend_intro-->
    <section class="coffee_signature">
        <h2>TWO SOME PLACE<br><span class="bTxt">Signature Coffee</span></h2>
        <section class="spanish">
            <h3 class="spanish_title">스페니쉬 연유라떼</h3>
            <p class="spanish_txt">
                <span class="bTxt">“평화로운 유럽초원의 감성을 담은 부드럽고 달콤함<br>스페니쉬 연유 라떼”</span> 스페니쉬 라떼는 야외에서 활동이<br>많은 스페인 목동들이 피곤함을 해소하기 위해 즐겨<br> 마시던 커피입니다.
            </p>
            <ul class="spanish_blend">
                <li class="blend_b">
                    <span class="bTxt">블랙그라운드 블렌딩 선택시</span><br>: 진한 원두의 깊은 풍미와 초콜릿과 같은 단맛의 라떼.
                </li>
                <li class="blend_a">
                    <span class="bTxt">아로마노트 블렌딩 선택시</span><br>: : 부드럽고 깔끔한 단맛이 느껴지는 라떼.
                </li>
            </ul>      
        </section><!--//spanish-->
        <section class="longblack">
            <h3 class="longblack_title">롱블랙</h3>
            <p class="longblack_txt">
                <span class="bTxt">“풍부한 크레마와 깊은 풍미”</span><br>롱블랙은 유럽 전역에서 즐기는 커피로<br>적은 양의 물에  에스프레소 투샷을 넣어 진하고 깊은<br>풍미가 매력적인 커피 입니다.
            </p>
            <p>
                리스트레또 투샷으로 <span class="bTxt">아메리카노 보다 진하고 부드러운
                풍미를 느낄수 있는 투썸의 시그니처 커피.</span>
            </p>
        </section><!--//longblack-->
    </section><!--//coffee_signature-->
    </main>
