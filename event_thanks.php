...
<html lang="ko">
  <head>
    ...
    <title>투썸플레이스 감사이벤트</title>
    <link rel="shortcut icon" href="img/favicon.ico">
    <link
      rel="stylesheet"
      href="css/event_thanks.css"
      type="text/css"
    />
   ...
   <div class="header_wrap">
    ...
    <section class="event">
       ...
       <h2>투썸플레이스 이벤트</h2>
        ...
        <section class="title">
            <p class="title_1">감사의 달 5월 투썸 Thanks 페어링 프로모션</p>
            <p>이벤트 기간 : 5/11 ~ 5/24</p>
        </section><!--//title-->
        <section>
            <p class="event_txt">
                감사의달 5월, 투썸Thanks 페어링을 즐겨보세요.<br>
                디저트+아메리카노(R)&amp;Thanks 경품이벤트<br>
                세트가격: 7,900원<br>2020.5월11일(월) ~ 5월24일(일)<br>
                행사디저트: 떠먹는 티라미수, 떠먹는 아이스박스, 떠먹는 딸기 레어 치즈, 떠먹는 헤이즐넛 생크림 크레이프, 뉴욕치즈, 그뤼에르 치즈 무스
            </p>
            <div class="thanks_event"></div>
        </section>
       </section><!--//event-->
