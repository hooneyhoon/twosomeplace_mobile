...
$sql = "select * from store_open where idx='$idx';";
...
<html lang="ko">
  <head>
    ...
    function form_check(){
        ...
        document.edit_store_open_form.submit();
    }
    </script>
  </head>
  <body>
   ...
   <div class="header_wrap">
    ...
    <section class="admin_store_open">
       <h2>투썸플레이스 신규 오픈 매장관리</h2>
       <p>
           <a href="admin_store_open.php" class="comeback">신규 오픈 매장 관리로 돌아가기</a>
       </p>
       <hr>
       ...
       <section class="store_open_registration">
           <h3>투썸플레이스 신규 오픈 매장등록</h3>
               ...
               <form name="edit_store_open_form" action="edit_store_open_ok.php" method="post">
                   <fieldset class="form">
                       <legend>투썸플레이스 신규 오픈 매장등록</legend>
                       <p class="store_date">
                           <label for="store_date" class="store_date_title"><span class="redTxt">*</span>오픈날짜</label>
                           <input type="text" name="store_date" id="store_date" class="store_date_input" value="<?php echo $array["store_date"] ?>">
                       ...
                       <p class="store_number">
                           ...
                           <input name="store_number" id="store_number" class="store_number_input" value="<?php echo $array["store_number"] ?>">
                       </p>
                   </fieldset><!--//form-->
                   <button type="button" onclick="form_check()" class="btn">신규 오픈 매장수정</button>
               </form>
       </section><!--//store_open_registration-->
    </section><!--//admin_store_open-->
    </main>
