...
$sql = "select * from cakeclass_reservation;";
...
<html lang="ko">
  <head>
    ...
    <title>투썸플레이스 케이크클래스 예약관리</title>
    <link rel="shortcut icon" href="img/favicon.ico">
    <link
      rel="stylesheet"
      href="css/admin_cakeclass.css"
      type="text/css"
    />
       ...
       <table>
           ...
           <?php
            ...
            <tr>
                ...
                <td width="500"><?php echo $array["store"]; ?></td>
                ...
                <td width="80"><?php echo $array["number_of_people"]; ?></td>
                <td width="600"><?php echo $array["class_time"]; ?></td>
                <td width="80"><?php echo $array["apply"]; ?></td>
                <td width="200"><?php echo $array["reg_date"]; ?></td>
                <td width="100">
                <a href="delete_cakeclass.php?idx=<?php echo $array["idx"]; ?>" class="redTxt">삭제</a>
            </td>    
            </tr>
            <?php
            }
