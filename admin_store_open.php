...
$sql = "select * from store_open order by idx desc;";
...
<html lang="ko">
  <head>
    ...
    <title>투썸플레이스 신규 오픈 매장관리</title>
    <link rel="shortcut icon" href="img/favicon.ico">
    <link
      rel="stylesheet"
      href="css/admin_store_open.css"
      type="text/css"
    />
    ...
    function form_check(){
        var store_date = document.getElementById("store_date");
        var store_name = document.getElementById("store_name");
        var store_number = document.getElementById("store_number");
        ...
        if(!store_name.value){
            alert("오픈매장명이 누락되었습니다.");
            store_name.focus();
            return false;
        }
        if(!store_number.value){
            alert("오픈매장 연락처가 누락되었습니다.");
            store_number.focus();
            return false;
        };
        
        document.store_open_form.submit();
    }
    </script>
  </head>
  <body>
   ...
   <div class="header_wrap">
    ...
    <div class="admin_store_open_title_bg"></div>
    <section class="store_open_sub">
        <p>
            <span class="redTxt">투썸플레이스</span>는 항상 고객님의 곁에 있습니다.
        </p>
    </section><!--//store_event_sub-->
    <section class="admin_store_event">
       <h2>투썸플레이스 신규 오픈 매장관리</h2>
       <p>
           <a href="administrator_mode.php" class="comeback">관리자 메뉴로 가기</a>
       </p>
       <hr>
       
       <section class="store_open_registration">
           <h3>투썸플레이스 신규 오픈 매장등록</h3>
               
               <form name="store_open_form" action="admin_store_open_ok.php" method="post">
                   <fieldset class="form">
                       <legend>투썸플레이스 신규 오픈 매장등록</legend>
                       <p class="store_date">
                           <label for="store_date" class="store_date_title"><span class="redTxt">*</span>오픈날짜</label>
                           <input type="text" name="store_date" id="store_date" class="store_date_input">
                       </p>
                       <p class="store_name">
                           <label for="store_name" class="store_name_title"><span class="redTxt">*</span>신규 오픈매장명</label>
                           <input type="text" name="store_name" id="store_name" class="store_name_input">
                       </p>
                       <p class="store_number">
                           <label for="store_number" class="store_number_title"><span class="redTxt">*</span>매장 연락처</label>
                           <input name="store_number" id="store_number" class="store_number_input">
                       </p>
                   </fieldset><!--//form-->
                   <button type="button" onclick="form_check()" class="btn">신규 오픈 매장등록</button>
               </form>
       </section><!--//store_open_registration-->
       <hr>
       <section class="event_management">
        <h3>투썸플레이스 신규 오픈매장 현황</h3>
        <section class="contents_title">
            <p class="c_t_1">번호</p>
            <p class="c_t_2">오픈날짜</p>
            <p class="c_t_3">오픈매장명</p>
            <p class="c_t_4">매장 연락처</p>
            <p class="c_t_5">수정</p>
            <p class="c_t_6">삭제</p>
        </section>
        <section>
           <?php
            ...
            <section class="contents">
                ...
                <p class="content_2"><?php echo $array["store_date"]; ?></p>
                <p class="content_3"><?php echo $array["store_name"]; ?></p>
                <p class="content_4"><?php echo $array["store_number"]; ?></p>
                <p class="content_5">
                    <a href="edit_store_open.php?idx=<?php echo $array["idx"]; ?>" class="redTxt">수정</a>
                </p>
                <p class="content_6">
                <a href="delete_store_open.php?idx=<?php echo $array["idx"]; ?>" class="redTxt">삭제</a>
                </p> 
            </section><!--//contents-->
                <?php
            $cnt--
