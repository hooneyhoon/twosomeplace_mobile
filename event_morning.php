...
<html lang="ko">
  <head>
    ...
    <title>투썸플레이스 모닝세트이벤트</title>
    <link rel="shortcut icon" href="img/favicon.ico">
    <link
      rel="stylesheet"
      href="css/event_morning.css"
      type="text/css"
    />
   ...
   <div class="header_wrap">
    ...
    <section class="event">
       ...
       <h2>투썸플레이스 이벤트</h2>
        ...
        <section class="title">
            <p class="title_1">모바일투썸 모닝 세트 스탬프 이벤트</p>
            <p>이벤트 기간 : 3/20 ~ 5/31</p>
        </section><!--//title-->
        <section>
            <p class="event_txt">
                모바일투썸 모닝세트 5+1스탬프<br>
                모바일 투썸 다운로드하고, 모닝세트 54ㅐ 스탬프 적립하면<br>모닝세트 1개 무료 쿠폰 증정<br>
                기간:2020.03.20(금)~5.31(일)<br>
                무료교환제품:플레인베이글with누텔라세트,호두베이글with누텔라세트,<br>스크램블에그샌드위치세트,에그베이컨브리오슈세트,토마토머쉬룸피자토스트세트,<br>크로크무슈세트,견과&amp;그래놀라바세트<br>
                유의사항:모닝세트 운영시간 대에만 참여가능합니다.<br>모닝세트에 한해 스탬프 적립됩니다.(모닝단품메뉴, 델리단품 및 세트메뉴, 무료증정메뉴, 기타할인메뉴 등 품목제회)<br>모바일투썸 투썸오더로 모닝세트 주문이 불가합니다.<br>자세한 이벤트 내용은 모바일투썸[이벤트]페이지를 참고해 주세요.
            </p>
            <div class="morning_event"></div>
        </section>
     </section><!--//event-->
