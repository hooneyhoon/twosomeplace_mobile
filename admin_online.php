...
$sql = "select * from online_counseling;";
...
<html lang="ko">
  <head>
    ...
    <title>투썸플레이스 온라인 창업상담 신청</title>
    <link rel="shortcut icon" href="img/favicon.ico">
    <link
      rel="stylesheet"
      href="css/admin_online.css"
      type="text/css"
    />
  ...
  <body>
   ...
   <div class="header_wrap">
    ...
    <section class="admin_members">
       <h2>투썸플레이스 온라인 창업상담 신청</h2>
       <p>
           <a href="administrator_mode.php" class="comeback">관리자 메뉴로 가기</a>
       </p>
       <hr>
       <p class="total_people">
            투썸플레이스 정보공개서 신청: 총 <span class=""><?php echo $num ?></span>건
       </p>
       <table>
           <tr class="title">
               <td width="80">번호</td>
               ...
               <td width="200">통화가능시간대</td>
               <td width="100">우편번호</td>
               <td width="600">주소</td>
               <td width="500">상세주소</td>
               <td width="100">가맹지소유여부</td>
               <td width="100">가맹지우편번호</td>
               <td width="600">가맹지주소</td>
               <td width="500">가맹지상세주소</td>
               <td width="80">가맹지평수</td>
               <td width="100">현가맹지상호</td>
               <td width="300">가맹희망지역</td>
               <td width="80">약관동의</td>
               <td width="200">신청일</td>
               <td width="100">삭제</td>
           </tr>
           ...
           <?php
            ...
            <tr>
                ...
                <td width="200"><?php echo $array["uname"]; ?></td>
                <td width="200"><?php echo $array["email"]; ?></td>
                <td width="150"><?php echo $array["mobile"]; ?></td>
                <td width="200"><?php echo $array["calltime"]; ?></td>
                <td width="200"><?php echo $array["postalcode"]; ?></td>
                <td width="600"><?php echo $array["address_1"]; ?></td>
                <td width="500"><?php echo $array["address_2"]; ?></td>
                <td width="100"><?php echo $array["store_hold"]; ?></td>
                <td width="200"><?php echo $array["store_postalcode"]; ?></td>
                <td width="600"><?php echo $array["store_address_1"]; ?></td>
                <td width="500"><?php echo $array["store_address_2"]; ?></td>
                <td width="80"><?php echo $array["space"]; ?></td>
                <td width="100"><?php echo $array["store_name"]; ?></td>
                <td width="100"><?php echo $array["hope_area"]; ?></td>
                <td width="80"><?php echo $array["apply"]; ?></td>
                <td width="200"><?php echo $array["reg_date"]; ?></td>
                <td width="100">
                <a href="delete_information.php?idx=<?php echo $array["idx"]; ?>" class="redTxt">삭제</a>
            </td>    
            </tr>
            <?php
            }
