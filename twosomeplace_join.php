...
<html lang="ko">
  <head>
    ...
    <title>투썸플레이스 회원가입</title>
    <link rel="shortcut icon" href="img/favicon.ico">
    <link
      rel="stylesheet"
      href="css/twosomeplace_join.css"
      type="text/css"
    />
    ...
    <script type="text/javascript">
      ...
      function id_check() {
        window.open(
          "search_id.php",
          "id",
          "width=500,height=300,left=200,top=50"
        );
      };
   ...
   <div class="header_wrap">
    ...
    <main>
      ...
      <section class="sub_title">
        <p>
          통합 아이디로 CJ ONE 브랜드 혜택도 받고! 포인트도 받고! 다양한 혜택을
          받아보세요.
        </p>
      </section>
      <!--//sub_title-->
      <div class="main_wrap_bg">
        <div class="main_wrap">
          <h2>
            <span class="title_bold">CJ ONE 통합회원가입</span> CJONE Integrated
            Membership
          </h2>
          <section class="join_box">
            <form name="join_form" action="join_ok.php" method="post">
              <fieldset class="member_info">
                ...
                <p class="form2">
                  ...
                  <input
                    ...
                    class="textbox_uid"
                  />
                  <button type="button" onclick="id_check()" class="check_uid">
                    중복확인
                  </button>
                </p>
                <p class="uid_txt">
                  CGV, CJmall, Mnet 등 기존의 CJ ONE 제휴 브랜드 회원님의
                  경우는<br />
                  기존에 사용하시고 계신 아이디가 새롭게 생성하신 통합 아이디로
                  변경됩니다.
                </p>
                <p class="form3">
              ...
              <fieldset class="terms_info">
                <legend class="apply_title">개인정보 수집 동의</legend>
                <p class="apply_txt">
                  1. 개인정보의 수집 및 이용 목적<br />
                  저희 투썸플레이스는 가맹점을 희망하는 고객님들께 '투썸플레이스
                  정보공개서' 열람 서비스를 제공하기 위하여 성명, 이메일,
                  연락처의 개인정보 항목을 수집합니다.<br />
                  2. 회원의 개인정보 보유, 이용기간과 파기<br />
                  투썸플레이스 정보공개서 열람 신청 등록일로부터 1달 이후에는
                  해당 정보를 지체없이 파기합니다.<br />
                  3. 개인정보의 파기 절차<br />
                  투썸플레이스 정보공개서 열람을 위해 입력한 정보는 목적이
                  달성된 후 별도의 DB로 옮겨져 내부방침 및 기타 관련 법령에 의한
                  정보보호 사유에 따라<br />
                  (보유 및 이용기간 참조) 일정 기간 저장된 후 파기되어 지며,
                ...
                <p class="form10">
                  <input
                    ...
                    class="checkbox"
                  />
                  <label for="apply" class="apply">동의합니다.</label>
                </p>
              </fieldset>
              <p class="form11">
