...
<html lang="ko">
  <head>
    ...
    <title>투썸플레이스 뉴스&amp;공지</title>
    <link rel="shortcut icon" href="img/favicon.ico">
    <link
      rel="stylesheet"
      href="css/twosomeplace_news.css"
      type="text/css"
    />
  ...
  <body>
   ...
   <div class="header_wrap">
    ...
    <section>
    <p class="title_text">
          <span class="redTxt">투썸플레이스</span>의 뉴스와 소식을 알려드립니다!
    </p>
    </section>
       ...
       <h2>투썸플레이스 뉴스&amp;공지</h2>
        ...
        <section class="content_title">
               ...
               <section class="contents">
                   ...
                   <p class="content_3"><a href="view_news.php?idx=<?php echo $array["idx"]; ?>"><?php echo $array["title"]; ?></a></p>
