...
$sql = "select * from store_event order by idx desc;";
...
<html lang="ko">
  <head>
    ...
    <link
      rel="stylesheet"
      href="css/admin_store_event.css"
      type="text/css"
    />
    ...
    function form_check(){
        ...
        document.store_event_form.submit();
    }
    </script>
  </head>
  <body>
    ...
    <section class="admin_store_event">
       ...
       <section class="store_event_registration">
           <h3>투썸플레이스 이벤트등록</h3>
               ...
               <form name="store_event_form" action="admin_store_event_ok.php" method="post">
                   <fieldset class="form">
                       ...
                       <p class="event_content">
                           ...
                           <input type="text" name="event_content" id="event_content" class="event_content_input">
                       </p>
                       <p class="event_time">
                           <label for="event_time" class="event_time_title"><span class="redTxt">*</span>행사기간</label>
                           <input name="event_time" id="event_time" class="event_time_input">
                       </p>
                   </fieldset><!--//form-->
                   <button type="button" onclick="form_check()" class="btn">이벤트등록</button>
               </form>
       </section><!--//store_event_registration-->
       <hr>
       <section class="event_management">
        <h3>투썸플레이스 매장별 이벤트 현황</h3>
        <section class="contents_title">
            <p class="c_t_1">번호</p>
            <p class="c_t_2">매장명</p>
            <p class="c_t_3">행사내용</p>
            <p class="c_t_4">행사기간</p>
            <p class="c_t_5">수정</p>
            <p class="c_t_6">삭제</p>
        </section>
        <section>
           <?php
            ...
            <section class="contents">
                ...
                <p class="content_2"><?php echo $array["store_name"]; ?></p>
                <p class="content_3"><?php echo $array["event_content"]; ?></p>
                <p class="content_4"><?php echo $array["event_time"]; ?></p>
                <p class="content_5">
                    <a href="edit_store_event.php?idx=<?php echo $array["idx"]; ?>" class="redTxt">수정</a>
                </p>
                <p class="content_6">
                <a href="delete_store_event.php?idx=<?php echo $array["idx"]; ?>" class="redTxt">삭제</a>
                </p> 
            </section><!--//contents-->
                <?php
            $cnt--
