...
<html lang="ko">
  <head>
    ...
    <title>투썸플레이스 현대카드이벤트</title>
    <link rel="shortcut icon" href="img/favicon.ico">
    <link
      rel="stylesheet"
      href="css/event_card.css"
      type="text/css"
    />
   ...
   <div class="header_wrap">
    ...
    <section class="event">
       ...
       <h2>투썸플레이스 이벤트</h2>
        ...
        <section class="title">
            <p class="title_1">투썸플레이스 X 현대카드 M포인트 50％ 프로모션<span class="event_end">이벤트종료</span></p>
            <p>이벤트 기간 : 12/16 ~ 12/25</p>
        </section><!--//title-->
        <section>
            <p class="event_txt">
               지금 현대카드로 결제하면?<br>
               행사기간: 2019.12.16 ~ 12.25<br>
               M포인트 사용 50%<br>
               대상카드: M포인트 적립 및 사용 가능한 모든 현대카드 (법인, gift카드 제외)<br> M포인트 부족시 잔여 포인트 만큼 사용 가능(10M포인트부터 사용 가능)<br>다른 쿠폰 및 제휴 할인 서비스, 타 행사와 중복적용 불가<br>일부 매장 M포인트 사용 불
            </p>
            <div class="card_event"></div>
        </section>
       </section><!--//event-->
