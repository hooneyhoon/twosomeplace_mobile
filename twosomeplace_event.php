...
<html lang="ko">
  <head>
    ...
    <title>투썸플레이스 이벤트</title>
    <link rel="shortcut icon" href="img/favicon.ico">
    <link
      rel="stylesheet"
      href="css/twosomeplace_event.css"
      type="text/css"
    />
  ...
  <body>
   ...
   <div class="header_wrap">
    ...
    <section class="event">
       ...
       <h2>투썸플레이스 이벤트</h2>
       <ul>
           <li class="event1"><a href="event_yogiyo.php">투썸 요기요 5월 슈퍼레드위크 프로모션</a></li>
           <li class="event2"><a href="event_morning.php">모바일투썸 모닝 세트 스탬프 이벤트</a></li>
           <li class="event3"><a href="event_thanks.php">감사의 달 5월 투썸 Thanks 페어링 프로모션</a></li>
           <li class="event4"><a href="event_keyring.php">투썸플레이스 스트로베리 키링 프로모션</a><span class="event_end">이벤트종료</span></li>
           <li class="event5"><a href="event_lucky.php">투썸 2020 럭키 드로우 이벤트</a><span class="event_end">이벤트종료</span></li>
           <li class="event6"><a href="event_card.php">투썸플레이스 X 현대카드 M포인트 50％ 프로모션</a><span class="event_end">이벤트종료</span></li>
       </ul>
    </section><!--//event-->
    </main>
